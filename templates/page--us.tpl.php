...
<!--						<div class="inner open fresh" ><span class="icon icon_phone"></span></div>-->
					...
					<div class="explorer__help-modal-inner">
						...
						<div class="explorer__help-modal-inner__copy">
							...
							<p>Contact Xplore Expert <span class="long-dash"></span> <span class="italic"><?php echo $contact_name; ?></span></p>
							<p class="avatar-block__copy__contact"><a href="tel:<?php echo str_replace(".", "", $contact_phone); ?>"><?php echo $contact_phone; ?></a> or <span id="comm100-button-<?php echo $livechat_planecode; ?>" class="avatar-block__copy__contact__chat" ></span></p>
						</div>
					</div>
				</div>
			</div>
